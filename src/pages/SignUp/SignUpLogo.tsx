...
const SignUpLogo = () => {
  return (
    <div className="col-[2/3] grid w-1/2 self-center justify-self-center max-[500px]:hidden">
      <svg
        id="Warstwa_1"
        data-name="Warstwa 1"
