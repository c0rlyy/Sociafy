...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="relative grid h-screen grid-cols-landing items-center justify-items-center border border-slate-500 bg-gradient-to-r from-cyan-500 to-blue-500">
      {mdScreen ? (
        <>
